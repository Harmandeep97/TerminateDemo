...
//            UserDefaults.standard.set(true, forKey: "backgroundState")
//            UserDefaults.standard.bool(forKey: "backgroundState")
        }
    ...
    func fetchSomeData() -> UIBackgroundFetchResult? {
